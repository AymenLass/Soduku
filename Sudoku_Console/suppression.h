...
// Proc�dure de suppression de possibiliteUnique et positionUnique
void supprimerPossibiliteZones(int ligneCase,
                               int colonneCase,
                               int possibilite,
                               int grille[9][9][10]);

// Proc�dures de suppression de possibilitesAlignees
...
// Proc�dures de suppression de nakedTuple
...
bool supprimerPossibilite(int possibilitesCase[10],
                          int possibilite);
